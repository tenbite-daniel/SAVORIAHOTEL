    ...
    <svg className="w-3 h-4" viewBox="0 0 11 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g clipPath="url(#clip0_391_277)">
            <g clipPath="url(#clip1_391_277)">
                <path d="M5.89805 14.4C7.30078 12.6445 10.5 8.38984 10.5 6C10.5 3.10156 8.14844 0.75 5.25 0.75C2.35156 0.75 0 3.10156 0 6C0 8.38984 3.19922 12.6445 4.60195 14.4C4.93828 14.8184 5.56172 14.8184 5.89805 14.4ZM5.25 4.25C5.71413 4.25 6.15925 4.43437 6.48744 4.76256C6.81563 5.09075 7 5.53587 7 6C7 6.46413 6.81563 6.90925 6.48744 7.23744C6.15925 7.56563 5.71413 7.75 5.25 7.75C4.78587 7.75 4.34075 7.56563 4.01256 7.23744C3.68437 6.90925 3.5 6.46413 3.5 6C3.5 5.53587 3.68437 5.09075 4.01256 4.76256C4.34075 4.43437 4.78587 4.25 5.25 4.25Z" fill="#D6D3D1"/>
            </g>
        </g>
        <defs>
...
const Footer = () => {
    ...
    return (
        <footer className="bg-neutral-800 border border-gray-200 text-white font-inter w-full max-w-[1440px] mx-auto flex flex-col justify-between min-h-[365px]">
            <div className="flex flex-1 px-16 pt-12 gap-16 flex-wrap">
                
                                <div className="flex-1 min-w-[200px]">
                                    <div className="flex items-center gap-3">
                                        <SavoriaIcon />
                                        <span className="font-bold text-2xl leading-8 tracking-normal text-white">
                                            Savoria
                                        </span>
                                    </div>
                                    <p className="font-normal text-base leading-5 text-gray-300 mt-2">
                                        Crafting exceptional dining experiences with passion and artistry.
                                    </p>
                                    <div className="mt-6 font-semibold text-lg leading-6 tracking-normal text-white">
                                        {isOpen ? (
                                            <span className="text-[#d97706]">We are Open</span>
                                        ) : (
                                            <span className="text-[#d97706]">We are Closed</span>
                                        )}
                                    </div>
                                </div>
                                ...
                                {/* Navigation */}
                                                <div className="flex-1 min-w-[160px]">
                                                    <div className="font-semibold text-lg leading-6 tracking-normal mb-4 text-white">
                                                        Navigation
                                                    </div>
                                                    <ul className="list-none p-0 m-0">
                                                        {[
                                                            ...
                                                            <li
                                                                key={item.name}
                                                                className="font-normal text-base leading-5 tracking-normal mb-2 text-gray-300"
                                                            >
                ...
                <div className="flex-1 min-w-[200px]">
                    ...
                    <div className="flex items-center gap-2 font-normal text-base leading-5 mb-2 text-gray-300">
                        <PhoneIcon />
                        (555) 123-4567
                    </div>
                    <div className="flex items-center gap-2 font-normal text-base leading-5 mb-2 text-gray-300">
                    ...
                    <a
                        ...
                        className="font-normal text-base leading-5 text-gray-300 underline ml-7 inline-block"
                    >
                        View on Google Maps
                    </a>
                </div>
                ...
                <div className="flex-1 min-w-[200px]">
                    ...
                    <div className="font-normal text-base leading-5 text-gray-300 mb-2">
                        Mon-Thur: 5.00AM - 10.00PM
                    </div>
                    <div className="font-normal text-base leading-5 text-gray-300 mb-2">
                        Fri-Sat: 5.00PM - 11.00PM
                    </div>
                    <div className="font-normal text-base leading-5 text-gray-300 ">
            ...
            {/* Bottom Bar */}
        <hr className="border-t border-gray-600 w-[1232px] mx-auto my-6" />
            <div className="flex items-center justify-between px-16 pb-6 w-full">
                <span className="font-normal text-base leading-5 text-gray-300">
