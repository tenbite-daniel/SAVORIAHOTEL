...
const SavoriaIcon = () => (
    <svg className="w-6 h-7" viewBox="0 0 21 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const LocationIcon = () => (
    <svg className="w-3 h-4" viewBox="0 0 11 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_391_277)">
            <g clipPath="url(#clip1_391_277)">
                <path d="M5.89805 14.4C7.30078 12.6445 10.5 8.38984 10.5 6C10.5 3.10156 8.14844 0.75 5.25 0.75C2.35156 0.75 0 3.10156 0 6C0 8.38984 3.19922 12.6445 4.60195 14.4C4.93828 14.8184 5.56172 14.8184 5.89805 14.4ZM5.25 4.25C5.71413 4.25 6.15925 4.43437 6.48744 4.76256C6.81563 5.09075 7 5.53587 7 6C7 6.46413 6.81563 6.90925 6.48744 7.23744C6.15925 7.56563 5.71413 7.75 5.25 7.75C4.78587 7.75 4.34075 7.56563 4.01256 7.23744C3.68437 6.90925 3.5 6.46413 3.5 6C3.5 5.53587 3.68437 5.09075 4.01256 4.76256C4.34075 4.43437 4.78587 4.25 5.25 4.25Z" fill="currentColor" className="text-gray-300 dark:text-gray-600"/>
            </g>
        </g>
        <defs>
...
const Footer = () => {
    ...
    return (
        <footer className="bg-neutral-800 dark:bg-gray-100 border border-gray-200 dark:border-gray-300 text-white dark:text-gray-900 font-inter w-full max-w-[1440px] mx-auto flex flex-col justify-between min-h-[365px] transition-colors duration-300">
            <div className="flex flex-1 px-16 pt-12 gap-16 flex-wrap">
                
                <div className="flex-1 min-w-[200px]">
                    <div className="flex items-center gap-3">
                        <SavoriaIcon />
                        <span className="font-bold text-2xl leading-8 tracking-normal text-white dark:text-gray-900">
                            Savoria
                        </span>
                    </div>
                    <p className="font-normal text-base leading-5 text-gray-300 dark:text-gray-600 mt-2">
                        Crafting exceptional dining experiences with passion and artistry.
                    </p>
                    <div className="mt-6 font-semibold text-lg leading-6 tracking-normal text-white dark:text-gray-900">
                        {isOpen ? (
                            <span className="text-[#d97706] dark:text-[#B45309]">We are Open</span>
                        ) : (
                            <span className="text-[#d97706] dark:text-[#B45309]">We are Closed</span>
                        )}
                    </div>
                </div>
                ...
                <div className="flex-1 min-w-[160px]">
                    <div className="font-semibold text-lg leading-6 tracking-normal mb-4 text-white dark:text-gray-900">
                        Navigation
                    </div>
                ...
                <div className="flex-1 min-w-[200px]">
                    ...
                    <div className="flex items-center gap-2 font-normal text-base leading-5 mb-2 text-gray-300 dark:text-gray-600">
                        <PhoneIcon />
                        (555) 123-4567
                    </div>
                    <div className="flex items-center gap-2 font-normal text-base leading-5 mb-2 text-gray-300 dark:text-gray-600">
                    ...
                    <a
                        ...
                        className="font-normal text-base leading-5 text-gray-300 dark:text-gray-600 underline ml-7 inline-block hover:text-white dark:hover:text-gray-900 transition-colors"
                    >
                        View on Google Maps
                    </a>
                </div>
            ...
            {/* Bottom Bar */}
            <hr className="border-t border-gray-600 dark:border-gray-400 w-[1232px] mx-auto my-6" />
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col justify-center">
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center gap-2 text-[#d97706] dark:text-[#B45309] hover:text-[#f59e0b] dark:hover:text-[#D97706] transition-colors font-medium text-sm"
                            >
                                <LocationIcon />
                            </a>
                        </div>
