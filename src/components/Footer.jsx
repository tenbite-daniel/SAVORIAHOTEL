...
const Footer = () => {
    ...
    return (
        <footer className="w-full bg-neutral-800 border border-gray-200 text-white font-inter mx-auto flex flex-col justify-between min-h-[365px]">
            ...
            {/* Bottom Bar */}
            <hr className="border-t border-gray-600 w-full mx-auto my-6" />
